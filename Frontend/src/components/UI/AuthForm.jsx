...
const AuthForm = ({
    ...
    return (
        <section className={`min-h-screen flex flex-col justify-center gap-8 items-center ${theme ? "bg-zinc-950 text-white" : "bg-gray-100 text-black"} max-sm:px-4`}>
            ...
            <form
                ...
                className={`space-y-6 flex flex-col w-full max-w-md shadow-xl ${theme ? "bg-zinc-900 text-white" : "bg-white text-black"}  p-12 rounded-md max-xl:order-2`}
            >
                ...
                {showNameField && (
                    <div className="relative">
                        ...
                        <label className={`absolute left-10 px-1 ${theme ? "bg-zinc-900 text-gray-500" : "bg-white text-black"} transition-all duration-200 ease-in-out pointer-events-none 
...
{showNameField && (
    <div className="relative">
        <select
            name="role"
            className={`block w-full border border-gray-300 rounded-md p-3 ${theme ? "bg-zinc-900 text-gray-500" : "bg-white text-black"} bg-transparent text-white`}
            value={formData.role || "user"}
            onChange={handleInputChange}
        >
            <option value="user"  className={`${theme ? "bg-zinc-900 text-white" : "bg-white text-black"}`}>User</option>
            <option value="admin" className={`${theme ? "bg-zinc-900 text-white" : "bg-white text-black"}`}>Admin</option>
        </select>
        <label className={`absolute left-10 px-1 -top-2 text-xs ${theme ? "bg-zinc-900 text-gray-500" : "bg-white text-black"}`}>
            Role
        </label>
    </div>
)}
